...
def train():
    ...
    storage = Storage(obs_dim=go_env.obs_dim, action_dim=go_env.action_dim, max_timesteps=500)
    ...
    rl_agent.learn(save_dir, num_learning_iterations=10000, num_steps_per_val=500)
